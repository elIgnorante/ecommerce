...
export const createCheckoutSession = async (req, res) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      seccess_url: `${process.env.CLIENT_URL}/purchase-success?session_id={CHECKOUT_SESSION_ID}`,
    ...
    try {
        ...
        if(session.payment_status === "paid") {
            ...
            const newOrder = new Order ({
                ...
                totalAmount: session.amount_total / 100, //Convierte de centavos a dolares
