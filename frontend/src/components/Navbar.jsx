...
export const Navbar = () => {
  ...
  return (
    <header
      className="fixed top-0 left-0 w-full bg-gray-900, bg-opacity-900 backdrop-blur-md shadow-lg z-40
    ...
    >
      <div className="container mx-auto px-4 py-3">
        ...
        <nav className="flex flex-wrap items-center gap-4">
          ...
          {user ? (
            <button className=" cursor-pointer bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 rounded-md flex items-center transition duration-300 ease-in-out"
            onClick={logout}>
                <LogOut size={18} />
